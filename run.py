...
def begin_adventure():
    ...
    """
    print()
    print("Hearing the rumours of the tomb of Mazar, you set off in search "
          "of fortune.\n")
    ...
    print(f"{player.name}: 'Somewhere inside is the fabled Treasure of "
          "Mazar!'\n")
...
def path_1():
    ...
    print(f"{player.name}: 'Should I try to open the door or go back the \n"
          "other way?'\n")
    door_choice()
    riddle_choice()
...
def path_2():
    ...
    print(f"{player.name}: 'What's up with these pots?\n"
...
def path_3():
    ...
    print(f"{player.name}: 'Brrr! It's freezing in here. Even my torch \n"
          "feels cold.'\n")
    print("As you make your way through the room, you feel like you're "
          "being watched.\n")
...
def feast_room():
    ...
    if player.blessing:
        ...
        print("You feel the power of the blessing at work and identify the "
              "poisoned food.\n")
        print(f"{player.name}: 'I'll have some of the tasty, non-poisoned\n"
              "food thanks!'\n")
...
def door_choice():
    ...
    if open_door.lower().strip() == "yes":
        ...
        print("In a panic, you look around the room, wondering where the "
              "voice came from.\n")
        print("You see the statue above the door staring at you with red "
              "eyes!\n")
        print(f"{player.name}: 'Um, my name is {player.name}!'\n")
        print(f"'Very well, {player.name.upper()}! Answer my riddle and\n"
              "you may pass.'\n")
...
def pot_choice():
    ...
    if choice.lower().strip() == "yes":
        ...
        print(f"{player.name}: 'Whoa! It seems to absorb all the light\n"
              "around it...'\n")
        print("You put the dagger in your bag.\n")
        player.dagger = True
    elif choice.lower().strip() == "no":
        print(f"{player.name}: 'I have a bad feeling about putting my hand\n"
              "in those pots.'\n")
...
def key_choice():
    ...
    if key_take.lower().strip() == "yes":
        ...
        print(f"{player.name}: 'This could be a trap...\n"
...
def truth_choice():
    ...
    if tell_truth.lower().strip() == "yes":
        ...
        print(f"???: 'You are a fool {player.name}...\nLies do not get past "
              "me.'\n")
        death()
    else:
        print("Please type Yes or No!")
...
def end_3():
    ...
    print("You managed to take them to the market and sell them for a small "
          "fortune.\n")
    print("Though none believed your tales of the tomb.\n")
    print("You and your family moved to the city with the riches you made.\n")
    print("And began living a life of luxury that you always dreamed of.\n")
    print("""
     ________________________
    |                        |
    |        ENDING 3        |
